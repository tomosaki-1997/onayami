...
<body>
    ...
    <div class="detail">
        <div class="container-white">
            <form method="POST" action="/create_comp" enctype="multipart/form-data">
                @csrf
            <div class="detail">
                <h1>
                    <div class="title">
                    ...
                    <div class="create-send">
                        ...
                        <div class="create-send-button">
                            <div class="create-send-button-back">
                                ...
                                <button type="button" onclick="history.back()" name="action" value="back">戻る</button>
                            </div>
